...
public class UserCertificationService {
    ...
    //身份认证信息上传
    public HashMap setCertificationInfo(Long uid,Long id_number,String real_name,String school,String major){
        HashMap<String, Object> responseBody = new HashMap<>();
        Integer status_code = 221;
        try{
            certificationMapper.update_one_with_more_info(uid,id_number,real_name,school,major);
        }catch (Exception e){
            System.out.println(e);
            status_code = 222;
        }finally {
